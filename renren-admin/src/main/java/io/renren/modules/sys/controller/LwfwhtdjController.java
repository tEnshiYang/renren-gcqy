...
public class LwfwhtdjController {
    ...
    @ResponseBody
    public LwfwhtdjEntity getCount(){
    	Integer xh=lwfwhtdjService.count()+1;
    	String res="-TS";
    	if((xh+"").length()==1){
    		res+="000"+xh;
    	}else if((xh+"").length()==2){
    	...
    	LwfwhtdjEntity lwfwhtdjEntity=new LwfwhtdjEntity();
    	lwfwhtdjEntity.setHtbh(res);
    	return lwfwhtdjEntity;
    }

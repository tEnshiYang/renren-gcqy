...
public class LwfwhtfkController {
    ...
    @ResponseBody
    public LwfwhtfkEntity getCount(){
    	Integer xh=lwfwhtfkService.count()+1;
    	String res="-";
    	if((xh+"").length()==1){
    		res+="000"+xh;
    	}else if((xh+"").length()==2){
    	...
    	LwfwhtfkEntity lwfwhtfkEntity=new LwfwhtfkEntity();
    	lwfwhtfkEntity.setZfbh(res);
    	
    	return lwfwhtfkEntity;
    }
    /**
     * 信息
     */
